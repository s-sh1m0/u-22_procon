...
// Colors follow `currentColor` so callers can tint them with Tailwind text-* utilities.

export function GitHubGlyph({ size = 14, className }: { size?: number; className?: string }) {
  return (
    <svg
      width={size}
      height={size}
